...
VALUES ('user', '$2a$10$NBQoRNzsXXZj7ziTVYg9qegglS4Y/XCitWTugwVs6gzjrlRnVJYG.', 'USER'),
       ('admin', '$2a$10$nDZY/CXRPgQ8/mUvJLTDQ.6axh7/5nBcPPB2RZ9qIBW3oHUakpHZy','ADMIN')
    ON CONFLICT (username) DO NOTHING;

INSERT INTO products (name, description, price, image)
VALUES ('Смартфон Galaxy S21', 'Флагманский смартфон Samsung с отличной камерой', 799.99, null),
